    ...
    <div className="single-page">
      ...
      <div className="media-infos">
        ...
        <p className="description">
          ...
          câlice.
          Je crisse mon camp d'icite anyway, je déguedine au plus sacrant, ça sent la cibole de
          marde.
          Yé un peu niaiseux le niochon de voisin, il crisse eu'rien avec sa vie. Quessé tu
          veux j'te
          dise sacrament, fouille-moé bout d'viarge, je le sais-tu moé. Osti qui fa frette.J'ai
          finalement pogné la twist pour faire la poutine. Je lui ai garôché une estie de
          garnotte en
